  ...
  return (
    <div className="min-h-screen bg-paper flex flex-col justify-between px-6 pt-4 pb-6 select-none animate-fadeIn">
      ...
      <header className="flex items-center justify-between h-14 pt-2">
        ...
        <span className="text-xs font-semibold tracking-widest text-muted uppercase">Create Account</span>
      </header>
      ...
      <main className="flex-1 flex flex-col justify-center max-w-sm w-full mx-auto my-auto space-y-6 py-4">
        <div className="space-y-1.5 text-left">
          ...
          <p className="text-sm text-muted leading-relaxed">Join Adhikar AI to protect your rights.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-muted uppercase tracking-wider mb-1.5">Email or Phone Number</label>
            <div className="relative flex items-center">
              <Mail size={18} className="absolute left-4 text-muted pointer-events-none" />
              <input
                type="text"
                required
                placeholder="ananya@example.com or +91 98765 43210"
                value={identifier}
